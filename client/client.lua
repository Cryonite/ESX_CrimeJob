  ...
  if Config.EnableArmoryManagement then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value == 'put_stock' then
            ...
            if data.current.valute == 'buy_stock' then
              OpenBuyStocksMenu()
            end
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_crimejob:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                ...
                TriggerServerEvent('esx_crimejob:handcuff')
              end
              ...
              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_crimejob:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_crimejob:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                  TriggerServerEvent('esx_crimejob:OutVehicle', GetPlayerServerId(player))
              end
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnableESXIdentity then
    ...
    ESX.TriggerServerCallback('esx_crimejob:getOtherPlayerData', function(data)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('esx_crimejob:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenFineCategoryMenu(player, category)
  ...
  ESX.TriggerServerCallback('esx_crimejob:getFineList', function(fines)
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_crimejob:getVehicleInfos', function(infos)
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_crimejob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
          ...
          ESX.TriggerServerCallback('esx_crimejob:removeArmoryWeapon', function()
            OpenGetWeaponMenu()
          end, data.current.value, data.current.weaponName)
  ...
  ESX.TriggerServerCallback('esx_crimejob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_crimejob:buy', function(hasEnoughMoney)

          if hasEnoughMoney then
            ESX.TriggerServerCallback('esx_crimejob:addArmoryWeapon', function()
            ESX.ShowNotification(("Je hebt een %s gekocht voor %.2f"):format(ESX.GetWeaponLabel(data.current.value), data.current.price))
              OpenBuyWeaponsMenu(station)
              menu.close()
            end, data.current.value)
          else
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_crimejob:getStockItems', function(items)
...
function OpenPutStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_crimejob:getPlayerInventory', function(inventory)
...
AddEventHandler('esx_crimejob:hasEnteredEntityZone', function(entity)
...
AddEventHandler('esx_crimejob:hasExitedEntityZone', function(entity)
...
AddEventHandler('esx_crimejob:handcuff', function()
...
AddEventHandler('esx_crimejob:OutVehicle', function(t)
  ...
  while true do
    ...
    if closestDistance ~= -1 and closestDistance <= 3.0 then
      ...
      if LastEntity ~= closestEntity then
        TriggerEvent('esx_crimejob:hasEnteredEntityZone', closestEntity)
      ...
      if LastEntity ~= nil then
        TriggerEvent('esx_crimejob:hasExitedEntityZone', LastEntity)
        LastEntity = nil
      end
